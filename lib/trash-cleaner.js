...
class TrashCleaner {
     ...
     */
    constructor(client, keywords, reporter, allowlist = [], actionLog = null, minAgeDays = null, seenCache = null) {
        this._client = client;
...
class TrashCleanerFactory {
    ...
    async getInstance() {
        ...
        const cleaner = new TrashCleaner(this._client, keywords, reporter, allowlist, this._actionLog, this._minAgeDays, seenCache);
        return cleaner;
    }
