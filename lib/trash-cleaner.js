...
class TrashCleaner {
     ...
     */
    constructor(client, keywords, reporter, allowlist = []) {
        this._client = client;
...
class TrashCleanerFactory {
     ...
     */
    constructor(configStore, client, cliMode, quiet = false) {
    ...
    async getInstance() {
        ...
        const reporter = new ConsoleProgressReporter(this._cliMode, this._quiet);
        const cleaner = new TrashCleaner(this._client, keywords, reporter, allowlist);
        return cleaner;
    }
