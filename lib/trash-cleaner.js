...
/** @typedef {import('./client/email-client').Email} Email */
/** @typedef {import('./client/email-client').EmailClient} EmailClient */
/** @typedef {import('./reporter/progress-reporter').ProgressReporter} ProgressReporter */
/** @typedef {import('./store/config-store').ConfigStore} ConfigStore */
/** @typedef {import('./utils/action-log').ActionLog} ActionLog */
