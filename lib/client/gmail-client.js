...
class GmailClient extends EmailClient {
     ...
     * 
     * @param {object} gmail An instance of gmail client.
     */
    constructor(gmail) {
        super();
        this._gmail = gmail;
    ...
    async getUnreadEmails() {
        const res = await retry(() => this._gmail.users.messages.list({
            userId: 'me',
            labelIds: 'UNREAD',
     ...
     * @returns {Promise<Email>} The email object.
     */
...
class GmailClientFactory extends EmailClientFactory {
     ...
     * @returns {Promise<GmailClient>} The Gmail client. 
     */
     ...
     * @param {boolean} reconfig Reconfigure auth secrets.
     * @param {boolean} launch Launch the auth url in the browser. 
     * @returns {Promise<object>} The authorization client.
     */
     ...
     * 
     * @param {typeof google.auth.OAuth2.prototype} auth The OAuth2 client to get token for.
     * @param {boolean} launch Launch the auth url in the browser. 
     */
